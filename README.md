...
OpenAdminJS is a free, open-source Laravel/Django-style admin framework for the Node.js ecosystem, built with Nest.js, Prisma, PostgreSQL, Next.js, TailwindCSS and shadcn/ui.
...
Email us at `partners@openadminjs.dev`.
...
- Contact maintainers for direct support options: `support@openadminjs.dev`.
